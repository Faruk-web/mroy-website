                ...
                <div class="card-body">
                    <table id="alternative-page-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('privacyy.edit', ['id' => $data->id])}}" class="btn btn-success btn-sm" title="Edit">
                                ...
                                <form action="{{route('privacyy.delete', ['id' => $data->id])}}" method="POST" id="privacyDeleteForm{{$data->id}}">
                                    @csrf
                                </form>
                                <script>
