                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="basic-form-preview">
                            <form action="{{route('propertyy.new')}}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="row mb-3">
                                    <label for="inputEmail34" class="col-3 col-form-label">Blog Name</label>
                                    <div class="col-9">
                                        <input type="text" class="form-control" name="name" id="inputEmail34" placeholder="Blog name"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <!-- <div class="row mb-3">
                                    <label for="inputEmail34" class="col-3 col-form-label">Multiimage</label>
                                    <div class="col-9">
                                        <div class="controls">
