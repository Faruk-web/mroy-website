                ...
                <div class="col-xl-4 col-lg-4 col-sm-6">
                    <div class="team-card style-2">
                        ...
                        <div class="team-content">
                            <h3 class="box-title"><a href="{{route('team.detail',$item->id)}}">{{ $item->name }}</a></h3>
                            <span class="team-desig">{{ $item->title }}</span>

                            <div class="team-social">
                              <a href="{{route('team.detail',$item->id)}}" class="link-btn"> Read More <i class="fa-regular fa-arrow-right-long"></i> </a>
                            </div>
                        </div>
                    </div>
                </div>
