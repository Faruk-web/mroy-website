                    ...
                    <aside class="sidebar-area">
                        <div class="widget widget_categories  ">
                            ...
                            @foreach($team as $item)
                                <li>
                                    <a href="{{route('practice.deatils',$item->id)}}">{{$item->name}}</a>
                        ...
                        <div class="widget  ">
                            ...
                            @foreach($team as $item)
                                <div class="recent-post">
                                    <div class="media-img">
                                        <a href="{{route('practice.deatils',$item->id)}}"><img src="{{ asset($item->image) }}" alt="Blog Image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="post-title"><a class="text-inherit" href="{{route('practice.deatils',$item->id)}}">{{$item->name}}</a></h4>
                                    </div>
                                </div>
                            @endforeach
                            </div>
                        ...
                        $settings = App\Models\Category::find(159);
                        @endphp
...
==============================-->
@php
     $settings = App\Models\Category::find(141);
      @endphp
