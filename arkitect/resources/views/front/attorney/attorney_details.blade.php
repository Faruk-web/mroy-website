...
@section('body')
@php
     $settings = App\Models\Category::find(145);
      @endphp
                ...
                <div class="col-xxl-4 col-lg-4">
                    <aside class="sidebar-area">
                        <div class="widget widget_categories  ">
                            <h3 class="widget_title">See Also...</h3>
                            <ul>
                            @foreach($team as $item)
                                <li>
                                    <a href="{{route('attorney.details',$item->id)}}">{{$item->name}}</a>
                        ...
                        <div class="widget  ">
                            ...
                            @foreach($team as $item)
                                <div class="recent-post">
                                    <div class="media-img">
                                        <a href="{{route('attorney.details',$item->id)}}"><img src="{{ asset($item->image) }}" alt="Blog Image"></a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="post-title"><a class="text-inherit" href="{{route('attorney.details',$item->id)}}">{{$item->name}}</a></h4>
                                    </div>
                                </div>
                            @endforeach
                            </div>
                        ...
                        $settings = App\Models\Category::find(157);
                        @endphp
